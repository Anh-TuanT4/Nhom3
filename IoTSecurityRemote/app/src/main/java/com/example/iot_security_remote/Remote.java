            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                try {
                    if(isChecked){
                        ...
                        values.put("keys", strkey);
                        values.put("cipher", ciphertextString);
                        ...
                        AESHelper.SecretKeys keys = AESHelper.generateKey();
                        // mã hóa dữ liệu
                        AESHelper.CipherTextIvMac cipherTextIvMac = AESHelper.encrypt("0", keys);
                        //store or send to server
                        String ciphertextString = cipherTextIvMac.toString();
                        ...
                        values1.put("keys", strkey);
                        values1.put("cipher", ciphertextString);
